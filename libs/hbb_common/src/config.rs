...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("N_Desk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["n103.top"];
pub const RS_PUB_KEY: &str = "Wlft5XCjhPVC5HlILK5NVbUREDzTpGWtZht63eCjzmI=";
